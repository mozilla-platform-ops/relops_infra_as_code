locals {
  ...
  # "projtaskcluster" would push the central-us storage account name past 24 characters.
  storage_account_suffix = "taskcluster"
...
module "proj_taskcluster_nogw" {
  ...
  azurerm_storage_account_name        = "sa${each.value}-${local.storage_account_suffix}"
