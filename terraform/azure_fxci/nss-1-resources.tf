resource "azurerm_resource_group" "nss1" {
  for_each = var.nss1
...
resource "azurerm_storage_account" "nss1" {
  for_each                 = var.nss1
...
resource "azurerm_network_security_group" "nss1" {
  for_each            = var.nss1
...
resource "azurerm_virtual_network" "nss1" {
  for_each            = var.nss1
